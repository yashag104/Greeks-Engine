...
// Config: WL=56 FL=28 mults=8 crot=3 cvec=2 cordic=iterative II=32 S=0 L=506 F=0 cycles/eval=4572
module heston_aad_z7h (
    ...
    output wire signed [55:0] sum_v0,
    output wire signed [55:0] sum_kappa,
    output wire signed [55:0] sum_theta,
    output wire signed [55:0] sum_xi,
    output wire signed [55:0] sum_rho,
    output wire signed [55:0] sum_x,
    output reg  done,
    ...
    wire in_setup = running && t < 32'd0;
    wire in_term  = running && t >= 32'd0 && t < 32'd4570;
    wire in_fin   = running && t >= 32'd4570;
    ...
    always @(posedge clk) begin
        if (rst) begin running <= 0; done <= 0; end
            ...
            if (start_evt) begin
                ...
                t <= t + 1;
                if (t == 32'd4570) begin running <= 0; done <= 1; end
            end
        end
    end
    ...
    always @(posedge clk) begin
        ...
        else if (running && t + 1 >= 32'd0) begin
            if (t + 1 == 32'd0) ph <= 0;
            else begin
    ...
    wire [6:0] mu0_sv = (mu0_S3 > 16'sd81) ? 7'd81 : ((mu0_S3 < 16'sd0) ? 7'd0 : mu0_S3 - 16'sd0);
    ...
    wire [5:0] mu1_sv = (mu1_S3 > 16'sd77) ? 6'd49 : ((mu1_S3 < 16'sd28) ? 6'd0 : mu1_S3 - 16'sd28);
    wire signed [111:0] mu1_bq = ($signed(mu1_Q) >>> 27);
    ...
    heston_aad_z7h_rot #(.WL(56)) cr0_inst (.clk(clk), .go(cr0_go), .a(cr0_x), .b(cr0_y), .o0(cr0_o0), .o1(cr0_o1));
    always @* begin
    ...
    heston_aad_z7h_rot #(.WL(56)) cr1_inst (.clk(clk), .go(cr1_go), .a(cr1_x), .b(cr1_y), .o0(cr1_o0), .o1(cr1_o1));
    always @* begin
    ...
    heston_aad_z7h_rot #(.WL(56)) cr2_inst (.clk(clk), .go(cr2_go), .a(cr2_x), .b(cr2_y), .o0(cr2_o0), .o1(cr2_o1));
    always @* begin
    ...
    heston_aad_z7h_vec #(.WL(56)) cv0_inst (.clk(clk), .go(cv0_go), .a(cv0_x), .b(cv0_y), .o0(cv0_o0), .o1(cv0_o1));
    always @* begin
    ...
    assign sum_T = acc_T;
    assign sum_r = acc_r;
    assign sum_v0 = acc_v0;
    assign sum_kappa = acc_kappa;
    assign sum_theta = acc_theta;
    assign sum_xi = acc_xi;
    assign sum_rho = acc_rho;
    assign sum_x = acc_x;
endmodule

module heston_aad_z7h_rot #(parameter WL = 56) (
...
module heston_aad_z7h_vec #(parameter WL = 56) (
    input wire clk, input wire go,
    input wire signed [WL-1:0] a, input wire signed [WL-1:0] b,
    output reg signed [WL-1:0] o0, output reg signed [WL-1:0] o1);
    localparam XW = 64, GB = 6, NIT = 30;
